<?php
$pageTitle = "Desenvolvimento sob medida | OTMiz Tech";
$pageDescription = "Sistemas web em Laravel/PHP construídos em torno do processo real da sua operação.";
  ...
  <section class="page-hero page-hero--split">
    ...
    <div class="container page-hero__row">
      <div class="page-hero__inner">
        ...
        <h1 class="page-hero__title" data-split>Desenvolvimento sob medida</h1>
        <p class="page-hero__subtitle" data-reveal>Sistemas web em Laravel/PHP construídos em torno do processo real da sua operação — CRMs, ERPs internos, plataformas de admissão e faturamento.</p>
      ...
      <div class="page-hero__media" data-reveal>
        <div class="hero-chart hero-chart--dev">
  ...
  <section class="feature-block">
    <div class="container feature-block__inner">
      <div class="feature-block__copy">
        <p class="eyebrow" data-reveal>Como entregamos</p>
        <h2 class="section-title" data-split>Do modelo de dados às regras de negócio</h2>
        <p data-reveal>Entregamos sistemas com autenticação, permissões (RBAC), filas assíncronas e painéis administrativos — prontos para escalar.</p>
      </div>
      <div class="feature-block__media" data-reveal aria-hidden="true">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2"><path d="M9 18l-6-6 6-6M15 6l6 6-6 6"/></svg>
      </div>
    </div>
  </section>
  ...
  <section class="feature-block feature-block--reverse">
    <div class="container feature-block__inner">
      <div class="feature-block__copy">
        ...
        <h2 class="section-title" data-split>Operações que precisam de um sistema próprio</h2>
